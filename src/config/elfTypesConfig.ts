...
export const elfCategories: ElfCategoryDef[] = [
  ...
  // Category-specific crews — each unlocks alongside its toy category and is the
  // ONLY crew that can staff that category's specialist station.
  {
    id: "musical",
    name: "Musical Elves",
    description: "The only elves who can tune Music Toys.",
    unlockUpgrade: "unlock_music",
  },
  {
    id: "athletic",
    name: "Athlete Elves",
    description: "The only elves who can balance Sports Equipment.",
    unlockUpgrade: "unlock_sports",
  },
  {
    id: "veterinary",
    name: "Veterinarian Elves",
    description: "The only elves who can train Animals.",
    unlockUpgrade: "unlock_animals",
  },
  {
    id: "nerd",
    name: "Nerd Elves",
    description: "The only elves who can wire up and configure Electronics.",
    unlockUpgrade: "unlock_electronics",
  },
  {
    id: "jewelry",
    name: "Jeweler Elves",
    description: "The only elves who can melt and polish Jewellery.",
...
export type ElfTypeDef = {
  ...
  /**
   * SPECIALIST: this elf can ONLY staff production steps requiring this exact
   * specialty (e.g. "musical" → Tuning), and conversely those steps accept
   * only this specialty. Generalist workers (no specialty) staff craft / QC /
   * packaging. See workforceHelpers.canElfTypeWorkStep + toyCategoriesConfig.
   */
  specialty?: string;
};
...
export const elfTypes: ElfTypeDef[] = [
  ...
  // ─── Specialist production crews — each locked to ONE category's station ──
  // (specialty gates both directions: they work only their station, and their
  // station accepts only them). Two tiers each: cheap-but-sloppy → pricey-but-clean.
  {
    id: "musician",
    name: "Apprentice Musician",
    icon: "🎻",
    description: "Tunes Music Toys — a little pitchy, but affordable.",
    category: "musical",
    role: "worker",
    specialty: "musical",
    baseCost: 300,
  ...
  },
  {
    ...
    name: "Maestro",
    icon: "🎩",
    description: "A perfect ear — tunes Music Toys flawlessly.",
    category: "musical",
    role: "worker",
    specialty: "musical",
    baseCost: 1500,
  ...
  },
  {
    ...
    name: "Fitness Coach",
    icon: "🏋️",
    description: "Balances Sports Equipment — decent, if a bit rough.",
    category: "athletic",
    role: "worker",
    specialty: "athlete",
    baseCost: 800,
  ...
  },
  {
    ...
    name: "Olympian",
    icon: "🥇",
    description: "Impeccable balance — Sports Equipment leaves flawless.",
    category: "athletic",
    role: "worker",
    specialty: "athlete",
    baseCost: 4000,
  ...
  },
  {
    ...
    name: "Vet Assistant",
    icon: "🩺",
    description: "Trains Animals — still learning the trade.",
    category: "veterinary",
    role: "worker",
    specialty: "vet",
    baseCost: 2000,
  ...
  },
  {
    ...
    name: "Veterinarian",
    icon: "👩‍⚕️",
    description: "A gentle expert — every Animal trained to perfection.",
    category: "veterinary",
    role: "worker",
    specialty: "vet",
    baseCost: 9000,
  ...
  },
  {
    ...
    name: "Geek",
    icon: "🤓",
    description: "Wires and configures Electronics — the occasional loose cable.",
    category: "nerd",
    role: "worker",
    specialty: "nerd",
    baseCost: 6000,
  ...
  },
  {
    ...
    name: "Hacker",
    icon: "👨‍💻",
    description: "Flawless wiring and firmware — Electronics never glitch.",
    category: "nerd",
    role: "worker",
    specialty: "nerd",
    baseCost: 25000,
  ...
  {
    id: "apprentice_jeweler",
    name: "Apprentice Jeweler",
    icon: "💍",
    description: "Melts and polishes Jewellery — a few smudges here and there.",
    category: "jewelry",
    role: "worker",
    specialty: "jeweler",
    baseCost: 20000,
  ...
  },
  {
    ...
    name: "Master Jeweler",
    icon: "💎",
    description: "A steady, flawless hand — Jewellery gleams every time.",
    category: "jewelry",
    role: "worker",
    specialty: "jeweler",
    baseCost: 90000,
